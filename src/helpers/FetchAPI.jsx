...
const AUTH_KEY = '9adb764dcbd165157ec52c929874934d';
...
function getReviews(id) {
  return axios.get(
    `${findURL}/${id}/reviews?api_key=${AUTH_KEY}&language=en-US&page=1`
  );
}

function getCredits(id) {
  return axios.get(
    `${findURL}/${id}/credits?api_key=${AUTH_KEY}&language=en-US`
  );
}
